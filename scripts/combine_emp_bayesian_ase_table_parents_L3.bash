...
do
    ...
    INPUT=$PROJ/empirical_bayesian_parents_output/split_${i}_l3

    OUTDIR=$PROJ/empirical_bayesian_parents_output

    # combine table
    python $PYGIT/catTable.py -f $INPUT/split_*.csv --odir $OUTDIR --oname PG_emp_bayesian_results_${i}_parents_l3.csv --header
