...
libname trago '/scratch/lfs/mcintyre/trago/sas_data';
...
data WORK.bed_&ONE._&TWO    ;
     ...
     infile "/scratch/lfs/mcintyre/trago/references/&ONE.-&TWO._overlaps_WRT_orthologs.csv" delimiter = ','
...
outfile ='/scratch/lfs/mcintyre/trago/references/TDU_tpo_bed_for_sam_compare.bed'
dbms=tab replace ;
run;
...
outfile ='/scratch/lfs/mcintyre/trago/references/TDU_tpr_bed_for_sam_compare.bed'
dbms=tab replace ;
run;
...
outfile ='/scratch/lfs/mcintyre/trago/references/TPO_tdu_bed_for_sam_compare.bed'
dbms=tab replace ;
run;
...
outfile ='/scratch/lfs/mcintyre/trago/references/TPR_tdu_bed_for_sam_compare.bed'
dbms=tab replace ;
run;
...
proc export data  = check outfile='/scratch/lfs/mcintyre/trago/references/check_bed_files.csv'
dbms=csv replace ;
run;
*/
